...
import { Brush, Code2, Server, Minus } from "lucide-react"
    ...
    <section id="about" className="scroll-mt-24 bg-secondary">
      <div className="container mx-auto px-8 py-24 ">
        <div className="w-full">
          ...
          {/* Main Heading */}
          <SectionHeader>
            <span className="text-primary">&lt; Get to </span>
            Know Me /&gt;
          </SectionHeader>
        ...
        <div className="mt-7 grid items-center gap-6 text-white lg:grid-cols-2">
          <div className="flex justify-center">
            <div className="relative w-full">
              <Image
                ...
                className="h-auto w-10/12 rounded-4xl border-[0.3px] border-primary/50 shadow-[0_0_40px_color-mix(in_srgb,var(--primary)_25%,transparent)] transition-all duration-500 hover:-translate-y-2 hover:border-primary hover:shadow-[0_0_60px_color-mix(in_srgb,var(--primary)_45%,transparent)]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mb-4 text-justify text-sm leading-7 text-muted-foreground sm:text-base sm:leading-7 lg:text-lg lg:leading-7">
              ...
              products using modern technologies and clean development
              practices.
            </p>
            ...
            <p className="mb-4 text-justify text-sm leading-7 text-muted-foreground sm:text-base sm:leading-7 lg:text-lg lg:leading-7">
              ...
              Express, Prisma, PostgreSQL, and MongoDB to build scalable and
            ...
            <p className="text-justify text-sm leading-7 text-muted-foreground sm:text-base sm:leading-7 lg:text-lg lg:leading-7">
              ...
              code that is not only functional but also clean, maintainable, and
              production-ready.
            </p>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {features.map((item) => {
            ...
            return (
              <Card
                key={item.title}
                className="h-full rounded-3xl border-[0.3px] border-primary/50 bg-background transition-all duration-400 hover:-translate-y-3 hover:border-primary hover:shadow-[0_0_30px_color-mix(in_srgb,var(--primary)_25%,transparent)]"
              >
