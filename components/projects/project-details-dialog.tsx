...
export default function ProjectDetailsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92dvh] max-h-[92vh] !w-[95vw] !max-w-6xl overflow-y-auto border-border bg-background p-0">
        {/* Hero */}
        <div className="grid overflow-hidden lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="relative h-64 min-h-full overflow-hidden bg-secondary sm:h-80 lg:h-[390px]">
            ...
            {/* Image Bottom */}
            <div className="absolute right-5 bottom-5 left-5 lg:hidden">
          ...
          <div className="flex flex-col justify-center border-l border-border bg-secondary/30 p-6 sm:p-8 lg:p-10">
            ...
            <DialogHeader className="text-left">
              <DialogTitle className="sr-only text-3xl leading-tight font-bold lg:not-sr-only lg:block xl:text-4xl">
                {project.title}
              </DialogTitle>
            ...
            {/* Hero Actions */}
            <div className="mt-6 flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-4">
              <Button
                asChild
                variant="primary"
                size="default"
                className="w-full flex-1 tracking-wide uppercase sm:w-auto"
              >
                <Link
                  href={project.live}
                  target="_blank"
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 border-t border-border pt-6">
              {project.stats.map((stat) => (
                <div
                  key={stat.label}
                  className="flex flex-col items-center justify-center rounded-xl border border-border bg-background/50 p-3"
                >
        ...
        <div className="space-y-8 p-6 sm:p-8 lg:p-10">
          {/* Technologies */}
          <section>
            <SectionHeading icon={<Layers3 />} title="Technologies" />
          ...
          {/* Features */}
          <section>
            <SectionHeading icon={<CheckCircle2 />} title="Key Features" />
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {project.features.map((feature) => (
                ...
                >
                  ...
                  <span className="transitions text-sm leading-5 text-muted-foreground group-hover:text-foreground">
                    {feature}
                  </span>
                </div>
              ))}
          ...
          {/* Challenge & Solution */}
          <section>
            <SectionHeading icon={<Target />} title="Development Process" />
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-secondary/30 p-5 sm:p-6">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold">The Solution</h3>
          ...
          <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-5 sm:flex-row sm:p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Explore the live application or check out the source code.
              </p>
            </div>
